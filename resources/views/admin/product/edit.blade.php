                ...
                <form action="{{url('update-product/'.$product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" value="{{ $product->meta_title }}" class="form-control" name="meta_title" id="meta_title">
                        </div>
                        <div class="col-md-12 mb-3">
                        ...
                        @if($product->image)
                            <img src="{{ asset('assets/uploads/product/'.$product->image) }}" class="cate-image" alt="Category Image">
                        @endif
                        <div class="col-md-12 mb-3">
